		...
		<div class="container-fluid">
            ...
            <section class="tabs-section">
				...
				<div class="col-lg-4">
					<fieldset class="form-group">
						...
						<select class="form-control" id="Cotizacion_ClienteId" onChange="GetUsuarioCliente()">
				...
				<div class="col-lg-4">
					<fieldset class="form-group">
						...
						<input type="text" class="form-control" id="Cotizacion_Contacto" >
					</fieldset>
				</div>
			...
			<div class="col-lg-4">
					<fieldset class="form-group">
						...
						<input type="text" class="form-control" id="Cotizacion_Correo" >
					</fieldset>
				</div>
			</div>
